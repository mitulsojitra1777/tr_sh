            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                     ...
                     <div class="card-body">
                    <div class="form-group row">
                           <label for="pickup_person" class="col-md-4 col-form-label text-md-right">{{ __('Pickup person') }}</label>

                            <div class="col-md-6">
                                <input id="pickup_person" type="text" class="form-control @error('pickup_person') is-invalid @enderror" name="pickup_person" required autocomplete="pickup_person">
                     ...
                     <div class="card-body">
                    <div class="form-group row">
                           <label for="pickup_contact" class="col-md-4 col-form-label text-md-right">{{ __('Pickup Person Contact') }}</label>

                            <div class="col-md-6">
                                <input id="pickup_contact" type="text" class="form-control @error('pickup_contact') is-invalid @enderror" name="pickup_contact" required autocomplete="pickup_contact">
                               


                                @error('pickup_contact')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                     ...
                     <div class="card-body">
                    <div class="form-group row">
                           <label for="drop_person" class="col-md-4 col-form-label text-md-right">{{ __('Drop Person') }}</label>

                            <div class="col-md-6">
                                <input id="drop_person" type="text" class="form-control @error('drop_person') is-invalid @enderror" name="drop_person" required autocomplete="drop_person">
                     ...
                     <div class="card-body">
                    <div class="form-group row">
                           <label for="drop_contact" class="col-md-4 col-form-label text-md-right">{{ __('Drop Person') }}</label>

                            <div class="col-md-6">
                                <input id="drop_contact" type="text" class="form-control @error('drop_contact') is-invalid @enderror" name="drop_contact" required autocomplete="drop_contact">
